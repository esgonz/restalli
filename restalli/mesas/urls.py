...
urlpatterns = [
    ...
    path('eliminar/<pk>/', views.MesaDelete.as_view(), name='delete'),
    path('editar/<pk>', views.MesaUpdate.as_view(), name='update'),
    path('movil/editar/<pk>', views.MesaUpdateMovil.as_view(), name='mupdate'),
    path('ver/<pk>', views.MesaDetailView.as_view(), name='detail'),
    path('movil/ver/<pk>', views.MesaDetailViewMovil.as_view(), name='mdetail'),
    ...
    path('reservas/eliminar/<pk>/', views.ReservaDelete.as_view(), name='resDelete'),
